...
public:
    ...
    // Not currently implemented. Should be trivial. Ask me if you need it.
    ...
    Result DrawPointList(Vector2D points[], Colour colour, const int numPoints);
...
private:
    ...
    PictureIndex m_nextFontIndex;		    // The index of the next font to be added
